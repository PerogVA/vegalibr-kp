...
tests = [
    # UNF
    ('Калибр-кольцо резьбовое ПР 1 1/8-12UNF 2A ASME B1.1',   1, 11700),
    ('Калибр-кольцо резьбовое НЕ 1 1/8-12UNF 2A ASME B1.1',   1,  9100),
    ('Калибр-кольцо резьбовое ПР 1 7/8-16UN 2A ASME B1.1',    1, 16900),
    ('Калибр-кольцо резьбовое НЕ 1 7/8-16UN 2A ASME B1.1',    1, 13000),
    ('Калибр-кольцо 1 1/16-14UNF-3А ПР и НЕ',                 1, 18200),
    # STUB ACME
    ('Калибр-кольцо 4,377-8 STUB ACME-2G ПР',                 1, 195000),
    ('Калибр-кольцо 4,377-8 STUB ACME-2G НЕ',                 1, 182000),
    ('Калибр-кольцо 4,750-8 STUB ACME-2G LH ПР',              1, 208000),
    ('Калибр-кольцо 4,750-8 STUB ACME-2G LH НЕ',              1, 195000),
